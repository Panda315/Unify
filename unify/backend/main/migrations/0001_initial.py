    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Password', models.CharField(max_length=200)),
                ('ClassroomId', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(), size=None)),
                ('DeptId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.department')),
            ],
        ),
        migrations.CreateModel(
            name='Routine',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Capacity', models.IntegerField()),
                ('DeptId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.department')),
                ('SchoolId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.school')),
            ],
        ),
        migrations.AddField(
