    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Password', models.CharField(max_length=200)),
                ('ClassroomId', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(), size=None)),
                ('DeptId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.department')),
            ],
        ),
        migrations.CreateModel(
            name='Routine',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('BuildId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.building')),
                ('DeptId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.department')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Like', models.IntegerField()),
                ('CourseId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.course')),
            ],
        ),
        migrations.AddField(
            model_name='course',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Sender', models.CharField(max_length=12)),
                ('Message', models.TextField()),
                ('ClassroomId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.classroom')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('StudentId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.student')),
            ],
        ),
        migrations.CreateModel(
            name='Administrator',
